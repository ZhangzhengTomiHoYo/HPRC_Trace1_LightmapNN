...
# 获取lightmap的配置参数
# 读取lightmap_list中的第一个lightmap在0点时的数据
lightmap = data['lightmap_list'][150]
id = lightmap['id']
...
# 获取path信息
lightmap_path = os.path.join(dataset_path, "Data", lightmap_names[time])
mask_path = os.path.join(dataset_path, "Data", masks_names[time])
